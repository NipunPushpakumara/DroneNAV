...
with PdfPages(pdf_name) as pdf:
    ...
    for flight_num, bad_logs_line in enumerate(logs_lines):
        ...
        plot_signal(flight_data, signal_num=-2, y_label="East Position (meters)", title=log_name)
        plot_signal(flight_data, signal_num=-3, y_label="North Position (meters)", title=log_name)
