...
model_architecture = [
    tf.keras.layers.LSTM(200, return_sequences=True), #200
    tf.keras.layers.LSTM(200, return_sequences=True),
    tf.keras.layers.LSTM(200, return_sequences=True),
    tf.keras.layers.LSTM(200, return_sequences=False), #200S
...
if create_new_dataset:
    ...
    colum_names = {"features"     : ["w_x","w_y","w_z","a_x","a_y","a_z","m_x","m_y","m_z","c_r","c_p","c_y","c_u"],
                    "features_diff": ["h"],
