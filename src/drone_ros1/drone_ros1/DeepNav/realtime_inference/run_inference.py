...
def sensors_listener():
    ...
    _ = rospy.Subscriber('human/body/imu', Imu, sensors_callback, "imu", queue_size=100)
    _ = rospy.Subscriber('human/body/magnetic', MagneticField, sensors_callback, "mag", queue_size=100)
    _ = rospy.Subscriber('human/body/pressure', FluidPressure, sensors_callback, "alt", queue_size=100)
    ...
    #TODO : NEED TO TAKE A DECISION HERE TO USE EKF OR NOT
